...
public abstract class Frame extends JFrame {
     ...
     * Noted this function will also run the initComponents() and initListeners() function.
     * in order to initialize the components and listeners of the panels written in the class that extends this class.
